...
# Edit CPQ Quote
#     ClickText             //span[@title\="Quotes"]
#     UseTable              Quote Number
#     ClickCell             r1/c?Quote Number
#     ${quoteID}            GetText                     Q-
#     ${quoteID}            Remove String               ${quoteID}    Preview
#     Set Suite Variable    ${quoteID}
#     ClickText             ${quoteID}    double_click=true
#     ClickText             ${quoteID}
